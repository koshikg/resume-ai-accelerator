...
%------------------------------------------------------------------------------
% Resume in Latex
% Author : Kaushik Gayal
% Based off of: https://github.com/koshikg/resume-ai-accelerator
% License : MIT
%------------------------------------------------------------------------------
%------------------------------------------------------------------------------
%------------------------------------------------------------------------------
...
\section{Earlier Roles}
    \resumeSubHeadingListStart
      \resumeProjectHeading
          {\titleItem{Wells Fargo} \emph{ $|$ Senior Technology Specialist, Technology Specialist, Senior Analyst}}{ 2012 -- 2018}
      \resumeProjectHeading
          {\titleItem{Wipro} \emph{ $|$ Software Engineer, Engineer Trainee}}{2010 -- 2012}      
    \resumeSubHeadingListEnd
% -------------------------------------
%----------EDUCATION-------------------
% -------------------------------------
